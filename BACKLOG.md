...
- [ ] **Config validation before run (Sprint 5)** — done: source required, workers 1–32, silence_thresh ≤ 0, valid sample rate and bit depth. Returns 400 with clear message shown in log panel.
